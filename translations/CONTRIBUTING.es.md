...
Busca primero en las [incidencias](https://github.com/panomahq/panoma/issues?q=is%3Aissue)
y los [pull requests](https://github.com/panomahq/panoma/pulls?q=is%3Apr), incluidos los
...
| --- | --- | --- |
| Un fallo | [Informe de fallo](https://github.com/panomahq/panoma/issues/new?template=bug_report.yml) | Lo esperado, lo ocurrido, pasos exactos, versión y sistema operativo. Si falla el escaneo, `panoma --version` ahorra media conversación. |
| Una función nueva o un cambio de arquitectura | [Propuesta](https://github.com/panomahq/panoma/issues/new?template=feature_request.yml), antes del código | El problema, cómo se resuelve hoy y por qué encaja en el norte de panoma. |
