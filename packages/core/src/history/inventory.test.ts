...
describe("inventoryHistory", () => {
  ...
  it("cuenta los transcripts de Claude Code, incluidos los de subcarpetas", async () => {
    const home = makeHome({
      ".claude/projects/-Users-yo-apuntes/uno.jsonl": "x".repeat(100),
      ".claude/projects/-Users-yo-apuntes/dos.jsonl": "x".repeat(50),
      ...
      ".claude/projects/-Users-yo-apuntes/uno.json": "j".repeat(9_000),
      ".claude/projects/-Users-yo-apuntes/adjunto.pdf": "p".repeat(9_000),
      ...
      ".claude/projects/-Users-yo-apuntes/uno/subagents/agent-abc.jsonl": "s".repeat(9_000),
    });
