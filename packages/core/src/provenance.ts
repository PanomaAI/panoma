 ...
 * *yours yet*, and distinguishing that matters: `menucard` has a commit, and that commit was written
 * by `create-next-app`.
 */
...
export function classifyOrigin(
  ...
  /*
    ...
    suffix as sufficient evidence, `leaselab-app-mobile-develop` —which belongs to the user, with
 ...
 * yours both for deducing the identity and for distributing authorship. Without this, kestrel
