...
const MESSAGES = {
  ...
  "families.summary":
    "{families} families · {folders} duplicate folders · {size} of repeated code",
  ...
  "scan.looksLikeCopies": "{n} look like copies · use -d to see them",
  ...
  "enrich.outdated": "{n} direct dependencies outdated",
  "enrich.advisories": "{n} security advisories",
  "enrich.affect": "affect {n} version{s} in use",
  ...
  "md.fileHead": "{file} · {tokens} tokens · {lines} lines",
  ...
  "cli.removed": "{n} no longer existed and were retired",
  "cli.catalogUpdated":
    "Catalog updated: {projects} project{ps}, {technologies} technologies, {packages} packages, {families} families",
  "cli.excluded": "{n} were skipped for living outside the catalog, as you asked",
