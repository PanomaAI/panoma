 ...
 * almost never the root: what is measured is `apuntes/apps/web`, `quiet_mark/frontend`,
 * `veloria/ios`. `resolveProject` already climbs up the tree to the deepest root that is a
