  ...
  return (
    ...
    >
      {/*
         ...
         It is rendered bare, without a `<PageSection>`, because the gap above it is its own: the
         component opens with `mt-10` and it is not this page's to decide.
        */}
      {/*
      ...
      {activity.length > 0 && (
        <PageSection title={t(locale, "agents.recentActivity")}>
