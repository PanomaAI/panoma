 ...
 *
 * Measured against this catalog: **32 of the 81 routes contain a space** —"brand assets" and
 * its four projects inside, "PORTAL copy", "hølm copy 2"—, so without quotation marks, four out of
