...
/*
  ...
  Here were GitHub Actions and Turborepo, and that put Ledgerly —a backtester in Python— and
...
export function projectCategories(project: ClassifiableProject): Set<Category> {
  ...
  /*
    ...
    been recognized: a `vel-control-panel` with React is a website with the word "control" inside,
    not a tool.
   */
