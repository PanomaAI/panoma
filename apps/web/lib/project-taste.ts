...
/*
  ...
  project —"this only applies in Ledgerly"—, the annotation travels to the file, the file goes
  down through `AGENTS.md`, and the agent working in Ledgerly reads it. All that worked, and from
 ...
 * `only in veloria:`. Without a name there is nothing to filter and the entire portrait comes
