 ...
 *
 * The failure that caused this: a project in `~/Documents/arca89/echoreel` did not appear in the
 ...
 * `~/Documents` and `~/Documents/arca89` monitored at the same time, every change triggers twice
 ...
 *
 * Only the first level: `~/Documents` comes out as a candidate, not `~/Documents/arca89`. A list
