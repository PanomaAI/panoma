...
const es = {
  ...
  "bridge.step.agent.purpose":
    "Da a Claude Code, Cursor u otro agente acceso al contexto y la memoria de tus proyectos por MCP: el parte, las notas y las nueve herramientas.",
...
const en = {
  ...
  "bridge.step.agent.purpose":
    "Give Claude Code, Cursor or another agent access to your project context and memory through MCP: the brief, the notes and the nine tools.",
