...
const es = {
  ...
  "catalog.down.body":
    "La web sigue en pie, pero sin datos. Aparta {path} con otro nombre y vuelve a arrancar: se crea uno nuevo y se rellena con «panoma scan». No borres nada: si algún día se puede rescatar, será de ahí.",
  ...
  "project.mdFileMeta": "{tokens} tokens · {lines} líneas",
  ...
  "project.assetsStats":
    "{n} recursos analizados · {platform} gestionados por la plataforma (no se miran) · {sources} ficheros de código leídos",
  ...
  "packages.stats":
    "{outdated} dependencias directas atrasadas · {advisories} avisos · comprobado {when}",
  ...
  "agents.entries": "{entries} entradas · {projects} proyectos",
  "agents.seen": "visto {when}",
  "agents.recentActivity": "Actividad reciente",

  // Familias de copias.
  "families.title": "{n} carpeta{s} que son copia",
  "families.intro":
  ...
  "families.stats": "{families} familias · {bytes} de código repetido",
  ...
  "hidden.count": "{hidden} ocultos y {excluded} fuera del catálogo",
  ...
  "unsaved.statOrphanCommits": "{n} commit{s} sin ninguna copia remota",
  ...
  "guard.localOperatorOnlyHint":
    "Abre el catálogo con el enlace de «esta máquina» que imprime «panoma up --network», o hazlo desde el propio ordenador.",
  ...
  "distill.noProvider": "Configura un proveedor con: panoma ai use <proveedor>",
  ...
  "model.connectHint":
    "Conecta uno en la página Modelo, o desde el terminal: panoma ai use <proveedor>",
  ...
  "model.hintKey":
    "Guarda la clave en la página Modelo o con «panoma ai key {id}». Se saca en {url}",
  ...
  "look.noProfile":
    "No hay con qué medir esta pantalla: tu retrato está vacío y este proyecto no tiene norte. Destila tu historial —panoma twin distill— o escribe un norte con panoma north.",
  "look.budgetSpent":
  ...
  "look.noInboxHint":
    "Se monta con «panoma md init» dentro del proyecto. A partir de ahí tus agentes leen en AGENTS.md dónde dejar lo que construyen, y aparece aquí.",
  "look.button": "Mirar",
   ...
   */
  "twin.corpusLeft":
    "Todo esto sale de {read} citas tuyas de las {total} que hay guardadas: quedan {left} sin leer.",
  /*
  ...
  "twin.distillEstimate": "esta pasada lee {verdicts} citas · unos {tokens} tokens de entrada",
  ...
  "twin.corpusDone": "Sale de tu historial entero: las {total} cita{totals} guardadas ya se han leído.",
  /*
  ...
  "twin.consentCount": "esperando: {n} · ocuparían en total: {chars} caracteres",
  "twin.consentOver":
  ...
  "twin.sourcesRevokeNote":
    "Dejar de leerla cierra la puerta y no borra lo que ya entró: eso lo hace panoma twin forget.",
  ...
  "runs.enrichAdvisories": "Ejecuta 'panoma enrich' para refrescar los avisos de OSV.",
  "runs.notADependency":
    "{package} no está entre las dependencias de {name}, o no sé cuál es su última versión.",
  "runs.enrichVersions": "Ejecuta 'panoma enrich' para traer las versiones de los registros.",
...
const en = {
  ...
  "catalog.down.body":
    "The app is still up, but with no data. Rename {path} to something else and start again: a fresh one is created, and «panoma scan» fills it. Delete nothing — if it can ever be rescued, it will be rescued from there.",
  ...
  "store.depsBehindRatio": "{n}/{total} outdated deps",
  ...
  "project.attnOutdated": "{n}/{total} dependencie{totals} behind",
  ...
  "project.assetsStats":
    "{n} assets analyzed · {platform} owned by the platform (not checked) · {sources} source files read",
  ...
  "packages.stats":
    "{outdated} direct dependencies behind · {advisories} advisories · checked {when}",
  ...
  "agents.entries": "{entries} entries · {projects} projects",
  "agents.seen": "seen {when}",
  "agents.recentActivity": "Recent activity",

  "families.title": "{n} folder{s} that are a copy",
  "families.intro":
  ...
  "families.stats": "{families} families · {bytes} of repeated code",
  "families.empty": "No copies in the catalog. Scan a folder with {cmd} to look for them.",
  "families.copiesAndSize": "{n} copie{s} · {bytes}",
  ...
  "hidden.count": "{hidden} hidden and {excluded} out of the catalog",
  ...
  "unsaved.statOrphanCommits": "{n} commit{s} with no remote copy anywhere",
  ...
  "guard.localOperatorOnlyHint":
    "Open the catalog with the “this machine” link that “panoma up --network” prints, or do it on the computer itself.",
  ...
  "distill.noProvider": "Set up a provider with: panoma ai use <provider>",

  "api.modelFailed": "Couldn’t ask the model: {detail}",
  "model.noneConnected": "no model is connected yet",
  "model.connectHint":
    "Connect one on the Model page, or from the terminal: panoma ai use <provider>",
  ...
  "model.hintKey": "Save the key on the Model page or with “panoma ai key {id}”. Get one at {url}",
  ...
  "look.noProfile":
    "There is nothing to measure this screen against: your portrait is empty and this project has no north. Distill your history —panoma twin distill— or write a north with panoma north.",
  "look.budgetSpent":
  ...
  "look.noInboxHint":
    "Mount it with “panoma md init” inside the project. From then on your agents read in AGENTS.md where to leave what they build, and it shows up here.",
  "look.button": "Look",
  ...
  "twin.corpusLeft":
    "All of this comes from {read} of the {total} quote{s} of yours that are stored: {left} still unread.",
  "twin.distillAll": "Read the rest of my history · {n} quote{s} left",
  "twin.distilling": "Reading…",
  "twin.distillEstimate": "this pass reads {verdicts} quotes · about {tokens} input tokens",
  "twin.distillProgress": "read: {read} · observations stored: {saved} · left: {left}",
  "twin.distillNothing": "There is no history left to read.",
  "twin.corpusDone": "It comes from your whole history: all {total} stored quotes have been read.",
  ...
  "twin.consentCount": "waiting: {n} · they would take: {chars} characters in total",
  "twin.consentOver":
  ...
  "twin.sourcesRevokeNote":
    "Stopping closes the door and doesn’t delete what already came in: that’s panoma twin forget.",
  ...
  "runs.enrichAdvisories": "Run 'panoma enrich' to refresh the OSV advisories.",
  "runs.notADependency":
    "{package} isn’t among {name}’s dependencies, or I don’t know its latest version.",
  "runs.enrichVersions": "Run 'panoma enrich' to pull versions from the registries.",
