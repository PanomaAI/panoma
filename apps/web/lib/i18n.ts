...
const es = {
  ...
  "handoff.digestNoModelNeeded": "Sin modelo conectado, el resumen que viaja es el mecánico: meta, ficheros, comandos y el último intercambio.",
  "handoff.digestDoorAi": "Conectar un modelo en IA",
  "handoff.digestDoorSpend": "Abrir Gasto",
...
const en = {
  ...
  "handoff.digestNoModelNeeded": "With no model connected, the digest that travels is the mechanical one: goal, files, commands and the last exchange.",
  "handoff.digestDoorAi": "Connect a model in AI",
  "handoff.digestDoorSpend": "Open Spend",
